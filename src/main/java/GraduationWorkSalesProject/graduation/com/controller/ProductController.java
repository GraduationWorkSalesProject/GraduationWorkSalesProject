...
public class ProductController {
	...
	public ResponseEntity<ResultResponse> register(
		...
		final Member findMember = memberService.findOneByUsername(username)
				.orElseThrow(InvalidCertificateException::new);

		ProductRegisterRequest productRegisterRequest = new ProductRegisterRequest(findMember, productName,
				productPrice, productInformation, categoryId, hashtags, productDeliveryTerm, productDeliveryPrice,
	...
	public ResponseEntity<ResultResponse> registerCategory(
			@Validated @RequestBody CategoryRegisterRequest categoryRegisterRequest) {
